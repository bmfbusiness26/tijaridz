  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-background px-4">
      <div className="max-w-md text-center">
        ...
        <p className="mt-2 text-sm text-muted-foreground">حدث خطأ غير متوقع. حاول مجدداً أو عد للرئيسية.</p>
...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#141419" },
      { title: "تِجَارِي | Tijari" },
      { name: "description", content: "تطبيق التاجر الجزائري: تحليل عقود الاستيراد، الفواتير الإلكترونية وحساب هامش الربح." },
